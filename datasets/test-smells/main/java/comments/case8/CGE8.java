...
class ImageBufferVariation {
     ...
     */
    public ImageBufferVariation(BufferedImage image) {
     ...
     */
    public ImageBufferVariation(int width, int height) {
        this.width = width;
        this.height = height;
        pixels = new long[width][height];
    }
 ...
 */
class ImageModelVariation {
    private final HashMap<String, ImageBufferVariation> loadedImages;

    public ImageModelVariation() {
        this.loadedImages = new HashMap<>();
    }

    public ImageBufferVariation getImage(String name) {
        return loadedImages.get(name);
    }

    public void setImage(String key, ImageBufferVariation image) {
     ...
     */
    public ImageBufferVariation alterBrightness(ImageBufferVariation image, float brightness) {
        int width = image.getWidth();
        int height = image.getHeight();

        ImageBufferVariation brightenedImage = new ImageBufferVariation(width, height);
