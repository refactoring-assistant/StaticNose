package switchstmts.case4;

abstract class Action {

    public abstract String getActionName();

    public abstract void execute(switchstmts.case4.CommandParserGood parser, int points);
...
class AttackAction extends Action {
    ...
    @Override
    public void execute(switchstmts.case4.CommandParserGood parser, int points) {
