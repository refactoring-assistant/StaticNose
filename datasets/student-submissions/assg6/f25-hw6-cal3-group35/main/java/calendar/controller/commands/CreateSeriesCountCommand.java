...
/**
 * Creates a timed repeating event series with a fixed count.
 */
public class CreateSeriesCountCommand implements CalendarCommand {
   ...
   */
  public CreateSeriesCountCommand(CalendarManager manager, ParsedCommand cmd) {
