...
/**
 * Class to edit a parameter in a series starting from some date.
 */
public class EditSeries implements CommandInterface {
   ...
   */
  public EditSeries(Map<String, Object> parameters,
    ...
    if (calendar == null || view == null) {
      throw new IllegalArgumentException(
          "Calendar or View is non-existent in EditSeries");
    }
  ...
  public void execute() {
    try {
      model.editSeries(this.parameters);
      String displayMessage = "Using calendar " + calendar.getCalendarName() + ": "
          + "Successfully edited a series called "
      ...
      view.displayError("EditSeries command: " + e.getMessage());
    }
  }
}