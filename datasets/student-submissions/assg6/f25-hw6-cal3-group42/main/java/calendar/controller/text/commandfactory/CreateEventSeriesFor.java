...
/**
 * Class to create an event repeating for 'n' times.
 */
public class CreateEventSeriesFor implements CommandInterface {
   ...
   */
  public CreateEventSeriesFor(Map<String, Object> parameters,
    ...
    if (calendar == null || view == null) {
      throw new IllegalArgumentException(
          "Calendar or View is non-existent in CreateEventSeriesFor");
    }
  ...
  public void execute() {
    try {
      ...
      view.displayError("CreateEventSeriesFor command: " + e.getMessage());
    }
  }
}
