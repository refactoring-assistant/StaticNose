 ...
 * All operations assume EST (America/New_York) timezone as per application requirements.
 * While LocalDateTime objects don't store timezone information, this parser documents
 * that all date/times in the application are treated as EST.
 * When exporting to Google Calendar or other systems, the timezone is implicitly EST.
 * This is documented here for clarity and future timezone support.
 */
public class DateTimeParser {
  ...
  public static LocalDateTime parseDateTime(String dateTimeString)
    ...
    try {
      ...
      throw new InvalidDateTimeException(
          "Invalid date-time format. Expected: YYYY-MM-DDThh:mm (e.g., 2025-05-05T14:30), got: "
              + dateTimeString, e);
    }
  }
   ...
   * Checks both format structure (YYYY-MM-DDThh:mm) and actual validity.
   * Useful for quick validation before attempting full parse.
   *
   * @param dateTimeString the date-time string to validate
   * @return true if format is valid and represents a real date-time, false otherwise
   */
