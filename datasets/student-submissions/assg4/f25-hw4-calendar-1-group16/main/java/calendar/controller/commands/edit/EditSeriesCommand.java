 ...
 */
public class EditSeriesCommand implements Icommands {
  private final Iview view;
  private final Matcher matcher;

  /**
   * Constructor for {@code editSeries}.
   *
   * @param view interface for displaying the message.
   * @param matcher pattern for creating mather groups.
   */
  public EditSeriesCommand(Iview view, Matcher matcher) {
    this.view = view;
  ...
  public void go(CalendarInterface model) throws IllegalArgumentException, IOException {
    ...
    model.editSeriesFromWith(property, subject, start, value);
    view.displayMessage("Series Updated: " + subject);
  }
}
