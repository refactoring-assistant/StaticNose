...
/**
 * This class represents the command used to create event series that repeats until a given
 * timestamp by the controller.
 */
public class CreateSeriesUntilCommand implements Command {
   ...
   * @param repeatUntil The timestamp until which the event should repeat.
   */
  public CreateSeriesUntilCommand(String subject, LocalDateTime startsAt, LocalDateTime endsAt,
                                  HashSet<DayOfWeek> weekdays, LocalDate repeatUntil) {
